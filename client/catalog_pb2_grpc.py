...
class CatalogStub(object):
  ...
  def __init__(self, channel):
    ...
    self.FilterProducts = channel.unary_unary(
        '/store.Catalog/FilterProducts',
        request_serializer=catalog__pb2.ProductFilter.SerializeToString,
        response_deserializer=product__pb2.ProductList.FromString,
        )
...
def add_CatalogServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'FilterProducts': grpc.unary_unary_rpc_method_handler(
          servicer.FilterProducts,
          request_deserializer=catalog__pb2.ProductFilter.FromString,
          response_serializer=product__pb2.ProductList.SerializeToString,
      ),
  }
