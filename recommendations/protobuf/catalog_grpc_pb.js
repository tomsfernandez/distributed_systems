...
function serialize_store_ProductFilter(arg) {
  if (!(arg instanceof catalog_pb.ProductFilter)) {
    throw new Error('Expected argument of type store.ProductFilter');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_store_ProductFilter(buffer_arg) {
  return catalog_pb.ProductFilter.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var CatalogService = exports.CatalogService = {
  ...
  filterProducts: {
    path: '/store.Catalog/FilterProducts',
    requestStream: false,
    responseStream: false,
    requestType: catalog_pb.ProductFilter,
    responseType: product_pb.ProductList,
    requestSerialize: serialize_store_ProductFilter,
    requestDeserialize: deserialize_store_ProductFilter,
    responseSerialize: serialize_store_ProductList,
    responseDeserialize: deserialize_store_ProductList,
  },
};
