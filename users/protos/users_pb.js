...
proto.store.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    name: jspb.Message.getFieldWithDefault(msg, 2, ""),
    email: jspb.Message.getFieldWithDefault(msg, 3, ""),
    lastLogin: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
/**
 * optional string last_login = 4;
 * @return {string}
 */
proto.store.User.prototype.getLastLogin = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.store.User.prototype.setLastLogin = function(value) {
